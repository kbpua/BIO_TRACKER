...
export const MOCK_PROJECTS = [
  { id: 'HGV-2023-001', name: 'Human Genome Variant Study', description: 'Investigating genetic variants associated with rare diseases in Filipino populations.', startDate: '2023-06-01', endDate: null, leadResearcher: 'Dr. Maria Santos', coResearchers: ['Dr. Juan Dela Cruz'], status: 'Active', publicationStatus: 'Published (public)' },
  { id: 'RBR-2023-002', name: 'Rice Blast Resistance Genes', description: 'Identifying resistance genes in Philippine rice cultivars against Magnaporthe oryzae.', startDate: '2023-08-15', endDate: null, leadResearcher: 'Dr. Juan Dela Cruz', coResearchers: ['Dr. Maria Santos'], status: 'Active', publicationStatus: 'Published (limited)', approvedExporters: ['Dr. Maria Santos'] },
  { id: 'ECA-2022-003', name: 'E. coli Antibiotic Resistance', description: 'Mapping antibiotic resistance patterns in clinical E. coli isolates.', startDate: '2022-01-10', endDate: '2024-01-30', leadResearcher: 'Dr. Liza Aquino', coResearchers: [], status: 'Completed', publicationStatus: 'Published (public)' },
